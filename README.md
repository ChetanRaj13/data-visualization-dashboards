...
### 🔹 Tableau Dashboards
#### 🛒 Retail Sales Dashboard (Bangalore)
- Business-focused analysis using Zomato Bangalore data
- Explores cuisine preferences, pricing, ratings, and ordering behaviour
- Designed to support **entrepreneurial decision-making**

📁 Path: `tableau/retail-sales-dashboard/`
...
### 🔹 Power BI Dashboard
#### ⚡ Energy Landscape of South America: Pre & Post Paris Agreement
- Uses **World Bank Indicators**
- Compares energy mix, resource wealth, electricity access, and exports
- Focuses on **impact of the Paris Agreement (2016)** on energy transition

📁 Path: `powerbi/energy-landscape-paris-agreement/`
...
- Policy and sustainability-oriented insights
...
## 📌 Note
Each dashboard is documented individually with its own README explaining:
- Problem statement
- Dataset
- Visualizations
- Insights
